    ...
    return (
        <>
            ...
            <div className="relative flex min-h-svh flex-col overflow-hidden bg-[#040a2a] text-white">
                ...
                <div className="pointer-events-none absolute inset-x-0 top-[18%] h-[17%] bg-[#050833]/95 blur-[2px]" />
                <div className="pointer-events-none absolute inset-x-0 top-[37%] h-[12%] bg-[#050833]/95 blur-[2px]" />
                <div className="pointer-events-none absolute inset-x-0 top-[51%] h-[18%] bg-[#050833]/95 blur-[2px]" />
