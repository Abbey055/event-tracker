        ...
        <>
            ...
            <div className="min-h-svh overflow-x-hidden bg-slate-50 text-slate-950">
                <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-5 sm:px-6 lg:px-8">
                    <Link href="/" className="flex min-w-0 items-center gap-3"><img src="/Event%20Tracker.png" alt="Event Tracker" className="size-16 shrink-0 object-contain" /><span className="truncate text-base font-semibold sm:text-lg">Event Tracker</span></Link>
